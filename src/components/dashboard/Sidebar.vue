...
const { isDrawerOpen } = storeToRefs(useDrawerStore());
</script>
<template>
  <aside
    class="fixed top-0 left-0 z-40 w-64 h-screen pt-14 transition-transform bg-white border-r border-gray-200 md:translate-x-0 dark:bg-slate-900 dark:border-gray-700"
    :class="{
      '-translate-x-full': !isDrawerOpen,
      'transform-none': isDrawerOpen,
    }"
    aria-label="Sidenav"
    id="drawer-navigation"
  >
    <div class="overflow-y-auto py-5 px-3 h-full bg-white dark:bg-slate-900">
    ...
    <div
      class="hidden absolute bottom-0 left-0 justify-center p-4 space-x-4 w-full lg:flex bg-white dark:bg-slate-900 z-20"
    >
      <a
        href="#"
