...
<template>
  <nav
    class="bg-white border-b border-gray-200 px-4 py-2.5 dark:bg-slate-900 dark:border-gray-700 fixed left-0 right-0 top-0 z-50"
  >
    <div class="flex flex-wrap justify-between items-center">
      ...
      <div class="flex items-center lg:order-2">
        ...
        >
          ...
          :src="`https://ui-avatars.com/api/?background=0D8ABC&color=fff&name=${user.user_metadata.full_name}`"
          alt="user photo"
        </button>
        <!-- Dropdown menu -->
        <div
